...
urlpatterns = [
   ...
   path('employee/dashboard/', views.employee_dashboard, name='employee_dashboard'),
    ...
    path('courses/<int:course_id>/payment', views.payment_page, name='payment_page'),
    path('courses/success/<int:course_id>/payment_success', views.payment_success, name='payment_success'),
