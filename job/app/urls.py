...
urlpatterns = [
    ...
    path("employee/jobs/<int:job_id>/published/", views.publish_success, name="publish_success"),
    ...
    # ================= PROFILES (IMPORTANT ORDER) =================
    # ✅ Router (nav uses this)
    path("my-profile/", views.profile_router, name="profile_router"),
